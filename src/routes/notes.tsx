...
import { ArrowLeft, Pin, Sparkles, MessageSquarePlus } from "lucide-react";
...
export const Route = createFileRoute("/notes")({
  head: () => ({
    meta: [
      { title: "Pinned notes — Stud AI" },
      { name: "description", content: "Save and revisit your most important study notes from any chat." },
      ...
      <div className="relative mx-auto w-full max-w-2xl">
        ...
        <div className="glass-panel rounded-3xl border border-border/60 p-8 text-center shadow-xl sm:p-12">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-muted-foreground sm:text-base">
            Pin explanations, formulas, or summaries from any chat so you can revise them quickly before exam day.
          </p>
          <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-border/60 bg-card/60 px-4 py-2 text-xs text-muted-foreground">
            ...
            Coming soon — save notes from your chats
          </div>
