...
import { ArrowLeft, TrendingUp, Sparkles, MessageSquarePlus } from "lucide-react";
...
export const Route = createFileRoute("/progress")({
  head: () => ({
    meta: [
      { title: "Progress — Stud AI" },
      { name: "description", content: "Track what you've studied and where you're improving." },
      ...
      <div className="relative mx-auto w-full max-w-2xl">
        ...
        <div className="glass-panel rounded-3xl border border-border/60 p-8 text-center shadow-xl sm:p-12">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-muted-foreground sm:text-base">
            See how much you've studied, which topics need more practice, and celebrate the streaks you build along the way.
          </p>
          <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-border/60 bg-card/60 px-4 py-2 text-xs text-muted-foreground">
            ...
            Coming soon — track study streaks and topic mastery
          </div>
